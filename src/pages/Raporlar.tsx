...
const Raporlar = () => {
  ...
  const exportSummaryToExcel = () => {
    const summaryData = [
      {
        'Lokasyon': 'DEPO',
        'Ürün Sayısı': depodaUrun
      },
      {
        'Lokasyon': 'ORGANİZASYON',
        'Ürün Sayısı': organizasyonUrun
      },
      {
        'Lokasyon': locationNames.servis,
        'Ürün Sayısı': servisteUrun
      },
      {
        'Lokasyon': locationNames.kiralama,
        'Ürün Sayısı': kiradaUrun
      },
      {
        'Lokasyon': 'TOPLAM',
